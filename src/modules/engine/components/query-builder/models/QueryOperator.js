...
export const OPERATORS = {
  equal: {
    ...
    nb_inputs: 1,
    multiple: false,
    apply_to: [FIELD_TYPES.REFERENCE, FIELD_TYPES.DATE, FIELD_TYPES.DATE_TIME, FIELD_TYPES.STRING, FIELD_TYPES.BIG_INTEGER, FIELD_TYPES.INTEGER, FIELD_TYPES.BOOLEAN, FIELD_TYPES.ENUM, FIELD_TYPES.UUID]
  },
  not_equal: {
    label: 'Not Equal',
    type: 'not_equal',
  ...
  in: {
    ...
    nb_inputs: 1,
    multiple: true,
    apply_to: [FIELD_TYPES.REFERENCE, FIELD_TYPES.DATE, FIELD_TYPES.DATE_TIME, FIELD_TYPES.STRING, FIELD_TYPES.BIG_INTEGER, FIELD_TYPES.INTEGER, FIELD_TYPES.UUID, FIELD_TYPES.ENUM]
  },
  not_in: {
    label: 'Not In',
    type: 'not_in',
